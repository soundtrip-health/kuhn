...
**Status:** draft for review with the sciwriter team (2026-09-09)
...
- Token-free check script (`webapp/scripts/interchange-check.mjs`) that pushes the fixture, adds a comment through the API, edits the doc, and pulls the export.
