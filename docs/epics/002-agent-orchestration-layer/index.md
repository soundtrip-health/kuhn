...
| 037 | [Chat panel widens and crushes the editor](stories/037-chat-panel-widens.md) — `flex: 0 0 380px` with no `min-width: 0`; one long URL takes the panel 380px→905px (measured). Same trap as 028 | ready | S |
